  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <motion.div 
          className="max-w-4xl mx-auto bg-[#151D29] rounded-xl p-8 border border-gray-800" 
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <button className="relative bg-green-500 text-white px-8 py-3 rounded-full flex items-center justify-center overflow-hidden group hover:shadow-lg hover:shadow-green-500/25 transition-all duration-300">
